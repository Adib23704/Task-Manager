...
-- AddForeignKey
ALTER TABLE "audit_logs" ADD CONSTRAINT "audit_logs_targetEntityId_fkey" FOREIGN KEY ("targetEntityId") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE CASCADE;
